...
| Confirm delete | Click 'delete' button in recipe written by user logged in, click 'confirm' button on confirm delete page. | Recipe object is successfully removed from database. | PASS |
