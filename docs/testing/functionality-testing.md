...
| Recipe form cancel button | Click cancel button on recipe form | User returned to 'browse' page, recipe form not submitted | PASS |
...
| Confirm delete | Click 'delete' button in recipe written by user logged in, click 'confirm' button on confirm delete page. | Recipe object is successfully removed from database, the user is redirected to the 'My Recipes' page. | PASS |
